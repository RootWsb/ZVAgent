...
class PluginManager:
    ...
    def load_config(self):
        ...
        plugins_conf = pconf.get("plugins", {})
        if "cow_cli" in plugins_conf and "zv_cli" not in plugins_conf:
            plugins_conf["zv_cli"] = plugins_conf.pop("cow_cli")
            modified = True
        elif "cow_cli" in plugins_conf:
            plugins_conf.pop("cow_cli", None)
            modified = True
