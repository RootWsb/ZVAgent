---
title: 模型概览
description: ZVAgent 支持的模型及推荐选择
---

ZVAgent 支持国内外主流厂商的大语言模型，模型接口实现在项目的 `models/` 目录下。
...
<Tip>
  全部模型名称可参考项目 [`common/const.py`](https://github.com/zhayujie/ZVAgent/blob/master/common/const.py) 文件。
</Tip>
