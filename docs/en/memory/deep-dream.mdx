...
Deep Dream is the core consolidation mechanism of ZVAgent's memory system, responsible for distilling scattered daily memories into refined long-term memory and generating dream diaries.

## Memory Flow

ZVAgent's memory progresses through three stages from short-term to long-term:
