---
title: v2.0.6
description: ZVAgent 2.0.6 - Knowledge Base, Deep Dream Memory Distillation, Smart Context Compression, Web Console Multi-Session and More
---

## Project Renamed to ZVAgent

The repository has been officially renamed from `chatgpt-on-wechat` to **ZVAgent**, evolving into a full-featured AI Agent assistant.

- New URL: [github.com/zhayujie/ZVAgent](https://github.com/zhayujie/ZVAgent) — GitHub auto-redirects the old URL
...
Docs: [Knowledge Base](https://docs.zvagent.ai/en/knowledge)
...
Docs: [Deep Dream](https://docs.zvagent.ai/en/memory/deep-dream)
...
Docs: [Short-term Memory](https://docs.zvagent.ai/en/memory/context)
...
- **Vision optimization**: Image recognition tool prefers the primary model with automatic multi-provider fallback. Docs: [Vision Tool](https://docs.zvagent.ai/en/tools/vision)
...
**Release Date**: 2026.04.14 | [Full Changelog](https://github.com/zhayujie/ZVAgent/compare/2.0.5...master)
