---
title: Changelog
description: ZVAgent version history
---
...
| [2.0.5](/en/releases/v2.0.5) | 2026.04.01 | ZV CLI, Skill Hub open source, Browser tool, WeCom Bot QR scan, and more |
...
See [GitHub Releases](https://github.com/zhayujie/ZVAgent/releases) for full history.
