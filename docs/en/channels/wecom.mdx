---
title: WeCom
description: Integrate ZVAgent into WeCom enterprise app
---

Integrate ZVAgent into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
