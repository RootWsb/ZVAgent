...
description: ZVAgent skills system introduction
---
...
ZVAgent offers multiple ways to acquire skills:

- **ZV Skill Hub** — Browse and install community skills via `/skill list --remote`
...
1. **Workspace skills** (highest): `~/zvagent/skills/`
