...
def parse_metadata(frontmatter: Dict[str, Any]) -> Optional[SkillMetadata]:
    ...
    # Unwrap nested namespace (e.g. {"openclaw": {...}} or {"zvagent": {...}})
...
_KNOWN_METADATA_NAMESPACES = {"zvagent", "cowagent", "openclaw"}


def _unwrap_metadata_namespace(metadata_raw: Dict[str, Any]) -> Dict[str, Any]:
    """
    Unwrap a single-key namespace wrapper like {"zvagent": {...} or {"openclaw": {...}}}.
