...
from agent.tools.utils.paths import resolve_workspace_path
...
class Read(BaseTool):
    ...
    def execute(self, args: Dict[str, Any]) -> ToolResult:
        ...
        env_config_paths = [expand_path("~/.zvagent/.env"), expand_path("~/.cow/.env")]
        if any(os.path.abspath(absolute_path) == os.path.abspath(p) for p in env_config_paths):
    ...
    def _resolve_path(self, path: str) -> str:
        ...
        """
        return resolve_workspace_path(path, self.cwd)
