...
def _repair_mojibake(value):
    """Repair common GBK-as-Latin1 mojibake returned by some search payloads."""
    ...
    try:
        ...
        return value
    # Only use the repaired text when it looks substantially more like CJK.
    if _cjk_count(repaired) > _cjk_count(value):
        return repaired
    return value
