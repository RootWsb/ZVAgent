...
- For destructive commands out of workspace, explain and confirm first"""
    ...
    def execute(self, args: Dict[str, Any]) -> ToolResult:
        ...
        if "~/.zvagent/.env" in command or "~/.zvagent" in command or "~/.cow/.env" in command or "~/.cow" in command:
        ...
        try:
            ...
            # Load environment variables from ~/.zvagent/.env if it exists.
            env_file = expand_path("~/.zvagent/.env")
