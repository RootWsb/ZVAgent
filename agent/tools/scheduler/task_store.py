...
class TaskStore:
    ...
    def __init__(self, store_path: str = None):
        ...
        Args:
            store_path: Path to tasks.json file. Defaults to ~/zvagent/scheduler/tasks.json
        """
        if store_path is None:
            # Default to ~/zvagent/scheduler/tasks.json
            home = expand_path("~")
            store_path = os.path.join(home, "zvagent", "scheduler", "tasks.json")
