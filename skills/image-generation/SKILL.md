...
## Research UI Visual Style

When generating images for ZVAgent analysis outputs, use a style that fits the web console unless the user asks for another style:

- Dark or transparent background, not a large white presentation canvas.
- Compact research-note layout with thin borders and 8px-radius panels.
- Restrained palette: slate/neutral base with blue, green, amber, or violet accents.
- Clear labels and simple geometry. Avoid poster-like composition, decorative gradients, stock-photo imagery, and heavy shadows.
- Use 16:9 or 3:2 aspect ratio for comparison diagrams and architecture schematics; avoid very tall images unless the content truly requires it.
- Prefer generated images only when Mermaid/SVG/table/chart code cannot express the visual cleanly.
